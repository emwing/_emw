function fullPage(){
  $("#js-fullpage").fullpage({
    ...
    onLeave:function(index,nextIndex,direction){
      ...
      if(0==state){
        var nextClass=".fp-section-"+nextIndex;anime.timeline().add({
...
$(window).on("load",function(){
  anime.timeline().add({
    ...
    easing:"easeInOutCubic",
    duration:800,
    complete:function(){$(".loader").addClass(".js-hidden")}
  }).add({
    targets:".js-moon",
    translateX:["100%",0],
    translateZ:0,
    ...
    offset:"-=1000"}).add({
      ...
      easing:"easeInOutCubic",
      duration:800,
      delay:function(el,i){return 50*i},offset:"-=1200"})
    });
...
$(function(){
  ...
  function(){
    ...
    window.matchMedia("(min-width: 801px)").matches?(
      ...
      console.log("pc"+isSp)):window.matchMedia("(min-width: 421px)").matches&&(
        isSp=!1,
        fpnav={y:"100%",x:0},
...
Barba.Dispatcher.on("newPageReady",function(){
  if($("#js-fullpage").length)new Parallax($(".js-parallax-moon").get(0)),
...
$(function(){
  ...
  $(".js-menuBtn").on("click",function(){
    ...
    $(this).hasClass("js-menuOpen")?(console.log("curation"),
      Barba.Pjax.getTransition=function(){return PageTransitionCurtain}):$("#js-fullpage").length?(console.log("top"),
...
var topTransition=Barba.BaseView.extend({
  ...
  onEnter:function(){
    ...
    $(".js-contact").on("click",function(){$(".menuIcon").removeClass("js-menuOpen"),
...
var underLayer=Barba.BaseView.extend({
  ...
  onEnter:function(){
    Barba.Pjax.getTransition=function(){return PageTransitionUnder},
    $(window).scroll(function(){$(".js-scroll").each(function(i){$(window).scrollTop()+$(window).height()>$(this).offset().top&&$(this).addClass("in")})}),
    isSp&&$(".page-top").height($(window).height()),console.log(isSp)
  },
  onEnterCompleted:function(){headerColor()anime.timeline({
    duration:500,
    easing:"easeInOutCubic"
    }).add({
      targets:".btn-wrap",
  ...
  onLeave:function(){state=1;anime.timeline({
    duration:500,
    easing:"easeInOutCubic"
    }).add({
      targets:".btn-wrap",
  ...
  open:function(){
    return new Promise(function(resolve){
      anime.timeline({
        ...
        top:[image.top,imageBig.top]}).add({
          targets:".fullpage__slide",
...
PageTransitionUnder=Barba.BaseTransition.extend({
  ...
  close:function(){
    return new Promise(function(resolve){
      ...
      0!==$(window).scrollTop()?$("body,html").animate({scrollTop:0},
        500,
        "swing",
        closeAnime.play):closeAnime.play()
    })
  },
  finish:function(){this.done()}
});
