<?php
  ...
  $comicsAll = array(
    ...
    array(
      "id"=>"inevitable",
      "title"=>"Inevitable",
      "description"=>"An eleven-page mini-comic following a unicorn's forlorn attempts to elude death. Inspired by Princess Mononoke, it uses experimental pacing and high&#8209;contrast&nbsp;style.",
      "pages"=>11
    ),
